...
So based on those observations I've created a function that will change every swear word into default value as 'swear_word', extract the website name and add it to the end of the headline, the delete ‘article_link’ column.
